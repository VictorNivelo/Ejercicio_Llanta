 ...
 * @author Victor
 */
public class VistaRegistrarUsuarioLista extends javax.swing.JFrame {
...
//        cargarPersonasDesdeJSON("ListaUsuarios.json");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaRegistrarUsuarioLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
